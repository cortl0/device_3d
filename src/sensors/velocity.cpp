...
void velocity::set_inputs(dBodyID body, bnn::cpu& brain_, u_word& count_input, u_word length, float range_from, float range_to, std::string& debug_str, bool verbose)
{
